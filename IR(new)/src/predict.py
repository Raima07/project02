...
if __name__ == "__main__":
    image_path = 'Leaf samples/sample_leaf_6.jpg'  # You can change this sample leaf path
    model_path = 'models/best_model.h5'  # Load the best version of the model, not the last epoch
    ...
    if result:
        ...
        print(image_path)
        print(f"✅ Predicted Disease: {predicted_label}/n Confidence: {confidence*100:.2f}%")
